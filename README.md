...
|-----|------------|
| ![Segmentation Demo](outputs/segmentation_demo1.gif) | <div align="center">

This project implements **multi-class semantic segmentation** of animals from the Oxford-IIIT Pets dataset.<br><br>

**Project Goals:**<br><br>
- Learn and apply the U-Net architecture for multi-class segmentation.<br>
- Gain hands-on experience working with images and masks.<br>
